...
document.getElementById("compute").addEventListener("click", async function() { showLoading(); setTimeout(async () => { await getTwinWidth(cyLeft, "tw1"); await getTwinWidth(cyRight, "tw2"); getSimilarity(); hideLoading();}, 100);});
