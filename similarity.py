...
G1 = Graph()
G1.add_vertex(Vertex("A", 0.5))
G1.add_vertex(Vertex("B", 0.6))
G1.add_vertex(Vertex("C", 0.9))
G1.add_vertex(Vertex("D", 0.9))
G1.add_vertex(Vertex("E", 0.9))
G1.add_vertex(Vertex("F", 0.8))
G1.add_edge("A", "B", (0.8, 0))
G1.add_edge("B", "C", (0.5, 1))
G1.add_edge("C", "D", (0.7, 1))
G1.add_edge("D", "E", (1, 1))
G1.add_edge("E", "F", (0.5, 0))
G1.add_edge("F", "A", (0.7, 1))
G1.add_edge("B", "E", (0.5, 1))
G1.add_edge("B", "D", (1, 1))
...
G2.add_vertex(Vertex("G", 0.6))
G2.add_vertex(Vertex("H", 0.9))
G2.add_vertex(Vertex("I", 0.9))
G2.add_vertex(Vertex("J", 0.9))
G2.add_vertex(Vertex("K", 0.9))
G2.add_vertex(Vertex("L", 0.9))
G2.add_edge("H", "G", (0.3, 0))
G2.add_edge("I", "H", (0.3, 1))
G2.add_edge("J", "I", (0.3, 1))
G2.add_edge("J", "K", (0.3, 1))
G2.add_edge("K", "L", (0.3, 1))
G2.add_edge("G", "L", (0.3, 1))
G2.add_edge("H", "K", (0.3, 1))
G2.add_edge("H", "J", (0.3, 1))

print("ehm" + f"{compute_similarity(G1, G2, "drast")}")